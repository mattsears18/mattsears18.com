...
<div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
  <LightboxImage
    ...
    alt="Lightwork store screenshot — home feed of volunteer tasks, captioned: Ask your community for help in 30 seconds"
    style={{
      width: '31%',
      minWidth: '160px',
      maxWidth: '240px',
  ...
  <LightboxImage
    ...
    alt="Lightwork store screenshot — map of nearby task locations, captioned: See who needs a hand near you"
    style={{
      width: '31%',
      minWidth: '160px',
      maxWidth: '240px',
  ...
  <LightboxImage
    ...
    alt="Lightwork store screenshot — task detail with volunteer signup, captioned: Choose who sees it — public or your group only"
    style={{
      width: '31%',
      minWidth: '160px',
      maxWidth: '240px',
